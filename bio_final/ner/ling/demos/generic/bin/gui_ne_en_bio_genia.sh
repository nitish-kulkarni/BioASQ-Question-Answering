...
ARGS="com.aliasi.tokenizer.IndoEuropeanTokenizerFactory,com.aliasi.sentences.MedlineSentenceModel,/models/ne-en-bio-genia.TokenShapeChunker,Biomedical English trained on NCBI's GeneTag Corpus"
