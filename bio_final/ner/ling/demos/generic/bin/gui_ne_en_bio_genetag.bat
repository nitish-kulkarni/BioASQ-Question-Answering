...
set ARGS="com.aliasi.tokenizer.IndoEuropeanTokenizerFactory,com.aliasi.sentences.MedlineSentenceModel,/models/ne-en-bio-genetag.HmmChunker,Biomedical English trained on NCBI's GeneTag Corpus"
